...
def init_database():
    ...
    questions_level1 = [
        (1, 'What is the primary purpose of law in society?', 'To restrict individual freedom', 'To maintain order and protect rights', 'To generate revenue for the government', 'To create confusion', 'B', 'Law serves to maintain social order, protect individual rights, and provide a framework for resolving disputes. It balances individual freedoms with societal needs.'),
        (1, 'What is the difference between civil law and criminal law?', 'There is no difference', 'Civil law deals with disputes between individuals, criminal law deals with offenses against society', 'Civil law is more serious than criminal law', 'Criminal law only applies to corporations', 'B', 'Civil law resolves disputes between parties (e.g., contracts, property), while criminal law addresses actions that harm society and are prosecuted by the state.'),
        (1, 'What does "precedent" mean in legal context?', 'A previous court decision used as a guide', 'A warning before arrest', 'A type of legal document', 'A court fee', 'A', 'Precedent refers to previous judicial decisions that serve as authority for deciding similar cases in the future, forming the basis of common law systems.'),
        (1, 'What is the burden of proof in a criminal case?', 'Preponderance of evidence', 'Beyond a reasonable doubt', 'Clear and convincing evidence', 'Probable cause', 'B', 'In criminal cases, the prosecution must prove guilt "beyond a reasonable doubt," which is the highest standard of proof, ensuring that innocent people are not convicted.'),
        (1, 'What is a statute?', 'A court decision', 'A written law passed by a legislative body', 'A legal contract', 'A type of lawsuit', 'B', 'A statute is a formal written law enacted by a legislative body (like Congress or Parliament) that governs behavior within a jurisdiction.')
    ]
    ...
    questions_level2 = [
        (2, 'What are the essential elements of a valid contract?', 'Only offer and acceptance', 'Offer, acceptance, consideration, capacity, and legality', 'Just a handshake', 'Only written agreement', 'B', 'A valid contract requires: offer, acceptance, consideration (something of value exchanged), legal capacity of parties, and legality of purpose.'),
        (2, 'What is "consideration" in contract law?', 'Thoughtful behavior', 'Something of value exchanged between parties', 'A legal document', 'A court hearing', 'B', 'Consideration is the benefit or value that each party receives or expects to receive from the contract. It can be money, services, goods, or a promise to do or not do something.'),
        (2, 'When can a contract be voided due to mistake?', 'Any mistake', 'Only mathematical errors', 'Mutual mistake of material fact', 'Spelling errors', 'C', 'A contract can be voided for mutual mistake when both parties are mistaken about a fundamental material fact that goes to the heart of the contract.'),
        (2, 'What is a breach of contract?', 'Breaking a physical object', 'Failure to perform contractual obligations', 'Signing a contract', 'Renegotiating terms', 'B', 'A breach of contract occurs when one party fails to fulfill their obligations under the contract without a valid legal excuse.'),
        (2, 'What are damages in contract law?', 'Physical injuries', 'Monetary compensation for breach', 'Contract terms', 'Legal fees', 'B', 'Damages are monetary compensation awarded to the injured party to compensate for losses suffered due to a breach of contract.')
    ]
    ...
    questions_level3 = [
        (3, 'What is the difference between a felony and a misdemeanor?', 'There is no difference', 'Felonies are more serious crimes with harsher penalties', 'Misdemeanors are always violent', 'Felonies cannot be prosecuted', 'B', 'Felonies are serious crimes typically punishable by imprisonment for more than one year, while misdemeanors are less serious offenses with lighter penalties.'),
        (3, 'What is "mens rea" in criminal law?', 'Physical evidence', 'Guilty mind or criminal intent', 'A type of defense', 'A court procedure', 'B', 'Mens rea refers to the mental state or intent required to commit a crime. Most crimes require both a criminal act (actus reus) and criminal intent (mens rea).'),
        (3, 'What is self-defense?', 'Defending property only', 'The right to use reasonable force to protect oneself from harm', 'Attacking first', 'Only applicable to police', 'B', 'Self-defense is a legal justification for using reasonable force to protect oneself or others from imminent harm when there is a reasonable belief of danger.'),
        (3, 'What does "beyond a reasonable doubt" mean?', 'Absolute certainty', 'The standard of proof required for criminal conviction', 'A type of evidence', 'A defense strategy', 'B', 'Beyond a reasonable doubt is the highest standard of proof, requiring that the evidence be so convincing that no reasonable person would doubt the defendant\'s guilt.'),
        (3, 'What is the difference between murder and manslaughter?', 'No difference', 'Murder requires intent, manslaughter is unlawful killing without malice', 'Manslaughter is more serious', 'Only murder is a crime', 'B', 'Murder is the intentional killing with malice aforethought, while manslaughter is unlawful killing without malice, often due to provocation or negligence.')
    ]
    ...
    questions_level4 = [
        (4, 'What is real property?', 'Property that is genuine', 'Land and anything permanently attached to it', 'Personal belongings', 'Intellectual property', 'B', 'Real property refers to land and anything permanently attached to it, such as buildings, trees, and minerals. It is immovable property.'),
        (4, 'What is a deed?', 'A legal action', 'A written document that transfers property ownership', 'A type of lease', 'A property tax', 'B', 'A deed is a legal document that transfers ownership of real property from one party (grantor) to another (grantee). It must be in writing and properly executed.'),
        (4, 'What is adverse possession?', 'Owning property legally', 'Acquiring property rights through continuous, open, and hostile use', 'Renting property', 'Selling property', 'B', 'Adverse possession allows someone to gain legal title to property by occupying it continuously, openly, and without permission for a statutory period (typically 7-20 years).'),
    ...
    questions_level5 = [
        (5, 'What is the purpose of the separation of powers?', 'To divide government into branches', 'To prevent any one branch from becoming too powerful', 'To create confusion', 'To increase government size', 'B', 'Separation of powers divides government into executive, legislative, and judicial branches, each with distinct powers, to prevent tyranny and protect liberty through checks and balances.'),
        (5, 'What are constitutional rights?', 'Rights granted by states only', 'Fundamental rights protected by the constitution', 'Rights that can be easily revoked', 'Only economic rights', 'B', 'Constitutional rights are fundamental rights and freedoms guaranteed by the constitution, such as freedom of speech, religion, and due process, which are protected from government infringement.'),
        ...
        (5, 'What is federalism?', 'A type of government', 'Division of power between national and state governments', 'Only national government', 'Only state government', 'B', 'Federalism is a system of government where power is divided between a central (federal) government and regional (state) governments, each with their own areas of authority.'),
        (5, 'What does "due process" mean?', 'Quick legal procedures', 'Fair legal procedures and protection of individual rights', 'Only criminal procedures', 'Administrative processes', 'B', 'Due process requires that the government follow fair and established legal procedures when depriving a person of life, liberty, or property, ensuring fundamental fairness and protection of rights.')
    ]
